...
int main(int argc, char** argv)
{
	...
	Star3dLayer *layer = new Star3dLayer(new StarCamera(Coordinate3d(0, -5, 0), Coordinate3d(0, 0, 0)));
	...
	layer->registerObject(new StarLight(Color3f(0.7,0.7,0.7), Color3f(0.8,0.8,0.8), Color3f(0.4,0.4,0.4), Coordinate3d(-20,-10,10), Coordinate3d(0,0,0), Coordinate3d(0,0,0)));
